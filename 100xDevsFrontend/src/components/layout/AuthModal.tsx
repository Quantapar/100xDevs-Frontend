...
export function AuthModal({
  ...
  const [currentMode, setCurrentMode] = useState<
    "login" | "signup" | "login_password" | "login_otp"
  >(mode);
  ...
  return (
    <div
      className="fixed inset-0 z-[1000] bg-[#04102d]/60 backdrop-blur-sm transition-opacity overflow-y-auto"
      onClick={onClose}
    >
        ...
        >
          ...
          <div className="w-full md:w-[48%] bg-[#04102d] rounded-[24px] px-8 pt-8 md:px-10 md:pt-10 flex flex-col relative overflow-hidden border-2 border-[#04102d] shadow-inner flex-shrink-0 min-h-[380px] md:min-h-[500px]">
            ...
            <div className="flex-grow flex items-end justify-center mt-6 relative z-10 pointer-events-none select-none">
              <img
                ...
                alt="Kirat Singh"
                className="w-[85%] max-w-[280px] h-auto object-contain object-bottom pointer-events-auto"
              />
            </div>
          </div>
          ...
          <div className="w-full md:w-[52%] p-8 lg:p-12 flex flex-col pt-12 md:pt-12 relative">
            <div className="flex items-center justify-center mb-8 lg:mb-12 relative w-full">
              ...
              <span
                className="text-[28px] sm:text-[32px] font-black tracking-tighter text-[#04102d]"
            ...
            {currentMode === "login" && (
              ...
              >
                <div>
                  <label className="block text-[15px] font-bold text-[#04102d] mb-2">
                    Phone Number/Email
                  </label>
                  <input
                    type="text"
                ...
                <div className="text-center mt-2">
                  ...
                  <button
                    ...
                    className="text-[14px] text-[#04102d] font-bold underline hover:text-[#0bae95] cursor-pointer"
                  >
                    Sign up
                  </button>
                </div>
              ...
              >
                <div>
                  ...
                  <div className="mt-3">
                    <button
                      type="button"
                      className="text-[14px] text-[#04102d] font-bold hover:text-[#0bae95] cursor-pointer"
                    >
                ...
                <div className="text-center mt-2">
                  {otpTimer > 0 ? (
                    <>
                      ...
                      <span className="text-[14px] text-[#04102d] font-bold underline cursor-pointer hover:text-[#0bae95]">
                        {otpTimer} seconds
                      </span>
                    </>
                  ) : (
                    <button
                      type="button"
                      onClick={() => setOtpTimer(20)}
                      className="text-[14px] text-[#04102d] font-bold underline cursor-pointer hover:text-[#0bae95] transition-colors"
                    >
                      Resend OTP
                    </button>
                  )}
            ...
            {currentMode === "signup" && (
              ...
              >
                <div>
                  <label className="block text-[13px] font-bold text-[#04102d] mb-1.5">
                    Full Name
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      if (signupErrors.state)
                        setSignupErrors({ ...signupErrors, state: "" });
                    }}
                  >
                ...
                <div className="text-center mt-1">
                  ...
                  <button
                    ...
                    className="text-[13px] text-[#04102d] font-bold underline hover:text-[#0bae95] cursor-pointer"
                  >
                    Log in
                  </button>
                </div>
            ...
            <div className="mt-8 md:mt-auto pt-6 text-center md:text-left">
              <p className="text-[13px] font-bold text-[#04102d]/70">
                ...
                <Link
                  ...
                  className="text-[#04102d] hover:text-[#0bae95] underline decoration-2 underline-offset-2 transition-colors cursor-pointer"
                >
                  Terms & Conditions
                </Link>{" "}
                &{" "}
