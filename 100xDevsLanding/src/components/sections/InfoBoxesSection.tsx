      ...
      <div className="bg-[#0bae95] border-2 border-[#04102d] rounded-[24px] p-8 lg:p-10 shadow-[8px_8px_0_#04102d] relative overflow-hidden flex flex-col justify-start">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-wrap gap-3">
            <span className="bg-white px-5 py-2.5 rounded-full text-[#0bae95] font-bold text-sm border-2 border-[#04102d] shadow-[3px_3px_0_#04102d] transition-transform hover:-translate-y-1">
      ...
      <div className="bg-[#04102d] border-2 border-[#04102d] rounded-[24px] p-8 lg:p-10 shadow-[8px_8px_0_#0bae95] relative overflow-hidden flex flex-col justify-start">
        ...
        <div className="relative z-10">
          <h2 className="text-3xl lg:text-4xl font-black text-white mb-4 leading-tight">
            ...
            <br />
            India's next 100x engineers
          </h2>
          <p className="text-[#e2eafb] font-semibold text-[17px] leading-relaxed max-w-md">
            Taking you from 1x to 100x through practical projects and real-world
            open source
          </p>
        </div>
      </div>
