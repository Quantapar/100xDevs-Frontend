    ...
    <section className="bg-white py-24 border-t-2 border-[#04102d]">
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-black text-[#04102d] mb-4">FAQs</h2>
          ...
          {faqs.map((faq, idx) => (
            ...
            >
              <div className="p-6 lg:p-8 flex items-center justify-between gap-4">
                ...
                <div className={`w-10 h-10 rounded-full border-2 border-[#04102d] flex items-center justify-center flex-shrink-0 transition-transform duration-300 ${openFaq === idx ? 'bg-[#0bae95] text-white rotate-180' : 'bg-white text-[#04102d]'}`}>
