    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#f8fafc]">
        <div className="text-center">
          <h2 className="text-2xl font-black text-[#04102d] mb-4">Product Not Found</h2>
          <button 
    ...
    <div className="w-full flex-grow bg-[#fafafa]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <div className="flex items-center gap-2 text-sm font-bold text-[#04102d]/60 mb-12">
          ...
          <span>›</span>
          <Link to="/store" className="hover:text-[#0bae95] transition-colors cursor-pointer">Store</Link>
          <span>›</span>
          ...
          <div className="w-full flex flex-col pt-4">
            ...
            <div className="mb-10">
              <div className="flex items-center justify-between mb-4">
                <span className="text-[16px] font-bold text-[#04102d]">Size: <span className="font-black">{selectedSize}</span></span>
                <button 
              ...
              <div className="px-4 sm:px-6 pb-4 sm:pb-6 pt-2 border-t-2 border-dashed border-gray-200">
                <ul className="flex flex-col gap-6 pt-4">
                  <li className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="font-bold text-[#04102d] mb-1">Package Type</p>
                      <p className="text-[15px] font-medium text-[#04102d]/70">Ships in regular packaging with protective wrapping to ensure safe delivery.</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    <Truck className="w-6 h-6 text-[#0bae95] shrink-0 mt-1" />
                    <div>
                      <p className="font-bold text-[#04102d] mb-1">Delivery Timeline</p>
                      <p className="text-[15px] font-medium text-[#04102d]/70">Standard delivery within 15-20 days from order confirmation. Express shipping available at checkout.</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    <RefreshCw className="w-6 h-6 text-[#0bae95] shrink-0 mt-1" />
                    <div>
                      <p className="font-bold text-[#04102d] mb-1">Return Policy</p>
                      <p className="text-[15px] font-medium text-[#04102d]/70">This product is non-returnable. Please check size and specifications carefully before ordering.</p>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="px-4 sm:px-6 pb-4 sm:pb-6 pt-2 border-t-2 border-dashed border-gray-200">
                <div className="pt-4">
                  <div className="mb-6">
                    ...
                    <p className="text-[15px] font-medium text-[#04102d]/80 leading-relaxed">Made from 100% premium cotton fabric with 300 GSM weight for superior quality and comfort.</p>
                  </div>
                  <div>
                    <p className="font-bold text-[#0bae95] mb-3">Care Instructions</p>
                    <ul className="flex flex-col gap-2 text-[15px] font-medium text-[#04102d]/80 list-disc ml-5">
                      <li className="pl-2 marker:text-[#0bae95]">Machine wash in cold water with similar colors</li>
                      <li className="pl-2 marker:text-[#0bae95]">Do not bleach or use harsh detergents</li>
                      <li className="pl-2 marker:text-[#0bae95]">Tumble dry on low heat or air dry</li>
                      <li className="pl-2 marker:text-[#0bae95]">Iron on medium heat if needed</li>
                      <li className="pl-2 marker:text-[#0bae95]">Do not dry clean</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="px-4 sm:px-6 pb-4 sm:pb-6 pt-2 border-t-2 border-dashed border-gray-200">
                <div className="pt-4">
                  <div className="mb-8">
                    ...
                    <p className="text-[15px] font-medium text-[#04102d]/80 leading-relaxed">This product features an oversized fit designed for a relaxed, comfortable wear. The loose silhouette provides extra room and a contemporary streetwear aesthetic.</p>
                  </div>
                  
                  <div>
                    <p className="font-bold text-[#0bae95] mb-4">Size Chart (in inches)</p>
                    <div className="overflow-x-auto rounded-xl border-2 border-[#04102d]">
                      <table className="w-full text-left border-collapse">
                        <thead>
                          <tr className="bg-[#04102d]/5">
                            <th className="py-3 px-4 font-black text-[#04102d] border-b-2 border-r-2 border-[#04102d]">Size</th>
                            <th className="py-3 px-4 font-black text-[#04102d] border-b-2 border-r-2 border-[#04102d]">Chest</th>
                            <th className="py-3 px-4 font-black text-[#04102d] border-b-2 border-r-2 border-[#04102d]">Length</th>
                            <th className="py-3 px-4 font-black text-[#04102d] border-b-2 border-[#04102d]">Shoulder</th>
                          </tr>
                        </thead>
                        <tbody>
                          {[
                            ...
                            <tr key={row.s} className="hover:bg-gray-50">
                              <td className={`py-3 px-4 font-bold text-[#04102d] border-r-2 border-[#04102d] ${i !== arr.length - 1 ? 'border-b-2' : ''}`}>{row.s}</td>
                              <td className={`py-3 px-4 font-medium text-[#04102d]/80 border-r-2 border-[#04102d] ${i !== arr.length - 1 ? 'border-b-2' : ''}`}>{row.c}</td>
                              <td className={`py-3 px-4 font-medium text-[#04102d]/80 border-r-2 border-[#04102d] ${i !== arr.length - 1 ? 'border-b-2' : ''}`}>{row.l}</td>
                              <td className={`py-3 px-4 font-medium text-[#04102d]/80 ${i !== arr.length - 1 ? 'border-b-2 border-[#04102d]' : ''}`}>{row.sh}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
                    ...
                    <p className="text-[13px] font-bold text-[#04102d]/60 mt-4 flex items-center gap-2">
                      ...
                      Tip: If you're between sizes, we recommend sizing up for the intended oversized look.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="relative bg-white rounded-[24px] w-full max-w-2xl overflow-hidden shadow-[8px_8px_0_#04102d] border-4 border-[#04102d] animate-in fade-in zoom-in duration-200">
            <div className="p-8">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h3 className="text-2xl font-black text-[#04102d] mb-2">Measurement Chart</h3>
                  <p className="text-[#04102d]/60 font-medium text-[15px]">Standard size measurements in inches.</p>
                </div>
                <button 
                  onClick={() => setIsSizeChartOpen(false)}
              ...
              <div className="overflow-x-auto rounded-xl border-2 border-[#04102d]">
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-[#04102d]/5">
                      <th className="py-4 px-6 font-black text-[#04102d] border-b-2 border-r-2 border-[#04102d]">Size</th>
                      <th className="py-4 px-6 font-black text-[#04102d] border-b-2 border-r-2 border-[#04102d]">Chest</th>
                      <th className="py-4 px-6 font-black text-[#04102d] border-b-2 border-r-2 border-[#04102d]">Length</th>
                      <th className="py-4 px-6 font-black text-[#04102d] border-b-2 border-[#04102d]">Shoulder</th>
                    </tr>
                  </thead>
                  <tbody>
                    {[
                      ...
                      <tr key={row.s} className="hover:bg-gray-50 transition-colors">
                        <td className={`py-4 px-6 font-bold text-[#04102d] border-r-2 border-[#04102d] ${i !== arr.length - 1 ? 'border-b-2' : ''}`}>{row.s}</td>
                        <td className={`py-4 px-6 font-medium text-[#04102d]/80 border-r-2 border-[#04102d] ${i !== arr.length - 1 ? 'border-b-2' : ''}`}>{row.c}</td>
                        <td className={`py-4 px-6 font-medium text-[#04102d]/80 border-r-2 border-[#04102d] ${i !== arr.length - 1 ? 'border-b-2' : ''}`}>{row.l}</td>
                        <td className={`py-4 px-6 font-medium text-[#04102d]/80 ${i !== arr.length - 1 ? 'border-b-2 border-[#04102d]' : ''}`}>{row.sh}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
