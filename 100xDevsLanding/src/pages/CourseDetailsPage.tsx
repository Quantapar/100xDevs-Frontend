  ...
  if (!course) {
    return (
      <div className="w-full flex-grow flex items-center justify-center bg-[#f8f9fa]">
        <h2 className="text-3xl font-black text-[#04102d]">
          Course not found.
        </h2>
      </div>
    );
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 lg:py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 mb-6">
          <div className="lg:col-span-7">
            <h2 className="text-3xl lg:text-4xl font-black text-[#04102d] tracking-tight">
              Course Syllabus
            </h2>
          </div>
        </div>
            ...
            {syllabusData.map((section, idx) => (
              ...
              >
                <div className="p-6 flex items-center justify-between gap-4">
                  ...
                  <div
                    className={`w-10 h-10 rounded-full border-2 border-[#04102d] flex items-center justify-center flex-shrink-0 transition-transform duration-300 ${openSyllabus === idx ? "bg-[#0bae95] text-white rotate-180" : "bg-white text-[#04102d]"}`}
                  >
        ...
        <div className="pt-12 mt-20 mb-20">
          <div className="text-center mb-12">
            <h2 className="text-4xl lg:text-5xl font-black text-[#04102d] tracking-tight mb-4">
              Who is This For?
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white border-4 border-[#04102d] rounded-[24px] p-8 shadow-[8px_8px_0_#0bae95] hover:-translate-y-2 hover:shadow-[12px_12px_0_#0bae95] transition-all flex flex-col items-center text-center">
              <div className="w-full aspect-[4/3] rounded-xl bg-white border-[3px] border-[#04102d] mb-6 overflow-hidden flex items-center justify-center p-4">
                <img
                  src="https://100xdevs.com/beginner.svg"
                  alt="Beginners in Tech"
                  className="w-full h-full object-contain"
                />
              </div>
              <h3 className="text-2xl font-black text-[#04102d] mb-3">
                Beginners in Tech
              </h3>
              <p className="font-bold text-gray-600">
                Those who want to start a career in software development with
                strong fundamentals.
              </p>
            </div>
            ...
            <div className="bg-white border-4 border-[#04102d] rounded-[24px] p-8 shadow-[8px_8px_0_#0bae95] hover:-translate-y-2 hover:shadow-[12px_12px_0_#0bae95] transition-all flex flex-col items-center text-center">
              <div className="w-full aspect-[4/3] rounded-xl bg-white border-[3px] border-[#04102d] mb-6 overflow-hidden flex items-center justify-center p-4">
                <img
                  src="https://100xdevs.com/developer.svg"
                  alt="Self-taught Developers"
                  className="w-full h-full object-contain"
                />
              </div>
              <h3 className="text-2xl font-black text-[#04102d] mb-3">
              ...
              <p className="font-bold text-gray-600">
                People who already know the basics but need a structured roadmap
                and real projects to become job-ready.
              </p>
            </div>
            ...
            <div className="bg-white border-4 border-[#04102d] rounded-[24px] p-8 shadow-[8px_8px_0_#0bae95] hover:-translate-y-2 hover:shadow-[12px_12px_0_#0bae95] transition-all flex flex-col items-center text-center">
              <div className="w-full aspect-[4/3] rounded-xl bg-white border-[3px] border-[#04102d] mb-6 overflow-hidden flex items-center justify-center p-4">
                <img
                  src="https://100xdevs.com/professional.svg"
        ...
        <div className="mb-20">
          <div
            className="bg-[#04102d] rounded-[32px] sm:rounded-[40px] border-4 border-[#04102d] overflow-hidden relative p-8 sm:p-12 lg:p-16 flex flex-col lg:flex-row items-center gap-12 lg:gap-20 shadow-[8px_8px_0_#0bae95] lg:shadow-[16px_16px_0_#0bae95]"
            style={{
              backgroundImage:
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white border-4 border-[#04102d] rounded-[24px] p-8 shadow-[8px_8px_0_#0bae95] hover:-translate-y-2 hover:shadow-[12px_12px_0_#0bae95] transition-all flex flex-col items-start">
              ...
              <p className="font-bold text-gray-600 leading-relaxed">
                Collaborate, build, and grow with thousands of passionate
                learners pushing their limits every day.
              </p>
            </div>
