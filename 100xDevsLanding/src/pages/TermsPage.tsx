    ...
    <div className="max-w-5xl mx-auto px-6 py-12 lg:py-20 lg:pb-32">
      ...
      <div className="flex flex-col gap-6 text-[15px] lg:text-[17px] font-semibold text-[#04102d]/80 leading-relaxed mb-12">
        <p>
          ...
          100xDevs relationship with you in relation to this website.
        </p>
        <p>
          The term "100xDevs" or "us" or "we" refers to the owner of the
      ...
      <div className="flex flex-col gap-10">
        <section>
          ...
          <ul className="list-disc pl-5 flex flex-col gap-3 text-[15px] lg:text-[17px] font-semibold text-[#04102d]/80">
            ...
            <li>
              ...
              suitability of the information and materials on this website for
        ...
        <section>
          ...
          <ul className="list-disc pl-5 flex flex-col gap-3 text-[15px] lg:text-[17px] font-semibold text-[#04102d]/80">
            <li>
              ...
              us, including design, layout, graphics and appearance.
            </li>
            <li>
            ...
            <li>
              All trademarks that are not the property of or licensed to the
        ...
        <section>
          ...
          <ul className="list-disc pl-5 flex flex-col gap-3 text-[15px] lg:text-[17px] font-semibold text-[#04102d]/80">
            <li>
              ...
              damages and/or may be a criminal offense.
            </li>
            <li>
              This website may include links to other websites for additional
              information. These links do not signify endorsement, and we are
              not responsible for their content.
            </li>
            <li>
              You may not create a link to this website from another website or
              document without prior written consent from 100xDevs.
            </li>
          </ul>
        </section>
        ...
        <section>
          <h2 className="text-2xl font-black text-[#04102d] mb-4">
            Payments, Usage & Liability
          </h2>
          <ul className="list-disc pl-5 flex flex-col gap-3 text-[15px] lg:text-[17px] font-semibold text-[#04102d]/80">
            <li>
              Credit card orders commence after authorization/confirmation from
              the respective payment gateway or card issuer.
            </li>
            <li>
              <strong className="font-extrabold text-[#04102d]">
                Educational Purpose Only:
              </strong>{" "}
              The platform is designed to help users develop skills. We do not
              guarantee any income or financial results.
            </li>
            <li>
              <strong className="font-extrabold text-[#04102d]">
                No Income Assurance:
              </strong>{" "}
              We do not promise jobs, business success or earnings.
            </li>
            <li>
              <strong className="font-extrabold text-[#04102d]">
                Non-Refundable:
              </strong>{" "}
              All payments are final. No refunds are provided in any case.
            </li>
            <li>
              <strong className="font-extrabold text-[#04102d]">
                User Responsibility:
              </strong>{" "}
              You are solely responsible for how you apply the skills learned.
              We are not liable for outcomes of your usage.
            </li>
          </ul>
        </section>
        ...
        <section>
          <p className="text-[15px] lg:text-[17px] font-bold text-[#04102d] mt-4">
            By continuing to use the app and website, you fully accept and agree
